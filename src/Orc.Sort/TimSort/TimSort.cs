// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TimSort.cs" company="Orcomp development team">
...
namespace System.Linq
{
    ...
    public static partial class TimSortExtender
    {
        ...
        public static void TimSort<T>(this T[] array)
        {
            ...
            if (TryNativeTimSort(array))
            {
                return;
            }

            if (TryComparableTimSort(array))
            {
                return;
            }
        ...
        public static void TimSort<T>(this T[] array, int start, int length)
        {
            ...
            if (TryNativeTimSort(array, start, start + length))
            {
                return;
            }

            if (TryComparableTimSort(array, start, start + length))
            {
                return;
            }
        ...
        public static void TimSort<T>(this List<T> array)
        {
            ...
            if (TryInternalTimSort(array, 0, array.Count))
            {
                return;
            }
        ...
        public static void TimSort<T>(this List<T> array, int start, int length)
        {
            ...
            if (TryInternalTimSort(array, start, length))
            {
                return;
            }
        ...
        public static void TimSort<T>(this List<T> array, int start, int length, Comparison<T> compare)
        {
            ...
            if (TryInternalTimSort(array, start, length, compare))
            {
                return;
            }
        ...
        public static void TimSort<T>(this List<T> array, Comparison<T> compare)
        {
            ...
            if (TryInternalTimSort(array, 0, array.Count, compare))
            {
                return;
            }
...
namespace TimSort
{
    ...
    internal class Int16ArrayTimSort : TimSortBase<Int16[], Int16>
    {
        ...
        // redirection
        internal static void SortAll(Int16[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(Int16[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class UInt16ArrayTimSort : TimSortBase<UInt16[], UInt16>
    {
        ...
        // redirection
        internal static void SortAll(UInt16[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(UInt16[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class Int32ArrayTimSort : TimSortBase<Int32[], Int32>
    {
        ...
        // redirection
        internal static void SortAll(Int32[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(Int32[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class UInt32ArrayTimSort : TimSortBase<UInt32[], UInt32>
    {
        ...
        // redirection
        internal static void SortAll(UInt32[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(UInt32[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class Int64ArrayTimSort : TimSortBase<Int64[], Int64>
    {
        ...
        // redirection
        internal static void SortAll(Int64[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(Int64[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class UInt64ArrayTimSort : TimSortBase<UInt64[], UInt64>
    {
        ...
        // redirection
        internal static void SortAll(UInt64[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(UInt64[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class SingleArrayTimSort : TimSortBase<Single[], Single>
    {
        ...
        // redirection
        internal static void SortAll(Single[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(Single[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
